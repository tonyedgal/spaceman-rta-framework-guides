    ...
    <div className='section-wrapper-compact mt-4'>
      <div className='w-full'>
        <div className='border-border grid grid-cols-1 gap-0 border-t sm:grid-cols-2 lg:grid-cols-3'>
              ...
              <div className='flex items-start gap-2.5'>
                ...
                <div>
                  ...
                  <p className='text-muted-foreground mt-1.5 font-mono text-sm md:text-base'>
                    As more things come to rely on software, the consequences of
                    bugs in the real world will only grow.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className='border-border bg-greptile-yellow/5 group relative w-full overflow-hidden border-r'>
            ...
            <div className='flex h-full flex-col p-5 pt-6 md:p-7'>
              <div className='flex items-start gap-2.5'>
                <div className='text-greptile-yellow mt-1 h-5 w-5 shrink-0 md:h-5 md:w-5'>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    width='20'
                    height='20'
                ...
                <div>
                  ...
                  <p className='text-tertiary mt-1.5 font-mono text-sm md:text-base'>
                    Humans will always be involved in building software, so
                    software will always have mistakes.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className='bg-primary/5 group relative w-full overflow-hidden'>
            ...
            <div className='z-20 flex h-full flex-col p-5 pt-6 md:p-7'>
              <div className='flex items-start gap-2.5'>
                <div className='text-greptile-orange mt-1 h-5 w-5 shrink-0 md:h-5 md:w-5'>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    width='20'
                    height='20'
                ...
                <div>
                  ...
                  <p className='text-tertiary mt-1.5 font-mono text-sm md:text-base'>
                    With AI, we have the opportunity to build highly intelligent
                    code verifiers that can catch hidden bugs that humans and
                    even testing cannot catch. We're doing just that.
                  </p>
                </div>
              </div>
            </div>
